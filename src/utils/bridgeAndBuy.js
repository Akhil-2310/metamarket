...
import { USDC_BASE, USDC_LINEA, CHAIN_IDS, COMMERCE_CONTRACTS } from '../constants';
import { abi as commerceAbi } from '../abi/Commerce.json';
...
export const bridgeAndBuy = async ({ product, userAddress }) => {
  ...
  const publicClient = createPublicClient({
    chain: { id: productChainId, name: '', nativeCurrency: {}, rpcUrls: { default: { http: ['https://rpc'] } } },
    transport: http(),
  });
