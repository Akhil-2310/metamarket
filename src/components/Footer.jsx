      ...
      <div className="max-w-7xl mx-auto px-4 py-12 mt-[30px]">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">MetaMarket</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/list" className="text-gray-300 hover:text-blue-400 transition-colors">
                  List Product
                </a>
              </li>
              <li>
                <a href="/my" className="text-gray-300 hover:text-blue-400 transition-colors">
                  My Products
                </a>
              </li>
              <li>
        ...
        {/* Bottom Section */}
        <div className="border-t border-blue-600/30 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 MetaMarket. All rights reserved.
            </p>
